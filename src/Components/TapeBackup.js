...
function Tape({mainColor,name}) {
  ...
  return (
    <div id="tapeContainer" onClick={handleClick} className={ active ? "scaleUp" :""}>
    <div className='tapeName'>{name}</div>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 810 513.5">
      <g id="Tape">
        <g id={active ? "Tape1" :"Still1"}>
          <g id="TapeReel">
            <circle cx="234" cy="234" r="160" fill={secondaryColor}>
              {active && 
                <animate
                  attributeName="r"
                  begin="0s"
          ...
          <rect
            ...
            width="10.12"
            height="10.12"
            transform={active ? "translate(133.98 -98.04) rotate(29.74)" :"none"}
            fill="#f2f2f2"
          />
          <rect
            x="211.36"
            ...
            width="10.12"
            height="10.12"
            transform={active ? "translate(159.87 -72.49) rotate(29.74)":"none"}
            fill="#f2f2f2"
          />
          <rect
            x="264.37"
            ...
            width="10.12"
            height="10.12"
            transform={active ? "translate(501.7 -36.95) rotate(89.68)":"none"}
            fill="#f2f2f2"
          />
          <rect
            x="193.51"
            ...
            width="10.12"
            height="10.12"
            transform={active ? "translate(431.64 34.31) rotate(89.68)":"none"}
            fill="#f2f2f2"
          />
          <rect
            x="210.95"
            ...
            width="10.12"
            height="10.12"
            transform={active ? "translate(-73.39 137.84) rotate(-30.51)":"none"}
            fill="#f2f2f2"
          />
          <rect
            x="246.93"
            ...
            width="10.12"
            height="10.12"
            transform={active ? "translate(-99.41 164.56) rotate(-30.51)":"none"}
            fill="#f2f2f2"
          />
          <circle cx="234" cy="234" r="24.18" fill={secondaryColor} />
          <polygon
        ...
        <g id={active ? "Tape2" :"Still2"}>
          <g id="TapeReel">
            <circle cx="576" cy="234" r="161.97" fill={secondaryColor}>
              {active && 
                <animate
                  attributeName="r"
                  begin="0s"
          ...
          <rect
            ...
            width="10.12"
            height="10.12"
            transform={active ? "translate(179.04 -267.72) rotate(29.74)":"none"}
            fill="#f2f2f2"
          />
          <rect
            x="553.36"
            ...
            width="10.12"
            height="10.12"
            transform={active ? "translate(204.94 -242.17) rotate(29.74)":"none"}
            fill="#f2f2f2"
          />
          <rect
            x="606.37"
            ...
            width="10.12"
            height="10.12"
            transform={active ? "translate(841.77 -378.94) rotate(89.68)":"none"}
            fill="#f2f2f2"
          />
          <rect
            x="535.51"
            ...
            width="10.12"
            height="10.12"
            transform={active ? "translate(771.71 -307.68) rotate(89.68)":"none"}
            fill="#f2f2f2"
          />
          <rect
            x="552.95"
            ...
            width="10.12"
            height="10.12"
            transform={active ? "translate(-26.04 311.47) rotate(-30.51)":"none"}
            fill="#f2f2f2"
          />
          <rect
            x="588.93"
            ...
            width="10.12"
            height="10.12"
            transform={active ? "translate(-52.05 338.19) rotate(-30.51)":"none"}
            fill="#f2f2f2"
          />
      ...
      <g id="Cassette">
        ...
        <rect
          ...
          opacity="0.67"
        />
        <rect y="288" width="18" height="144" rx="3.98" fill={mainColor} />
        <rect
          x="792"
          y="288"
          width="18"
      ...
      <g id="Label">
        ...
        <rect x="54" y="90" width="45" height="45" fill={mainColor} />
        <path
